...
* All of the chapter pages on the DATA606.net website have been updated.
* Fixed an issue in the homework 7 template where the downloaded data file would not load. Need to add the `mode = "wb"` parameter to the `download.file` function.
...
* 6.9 Study abroad - [Md Forhad Akbar](http://rpubs.com/forhadakbar/data606_presentation)
